<?php $class = $thread->isUnread(Auth::id()) ? 'alert-info' : 'alert-light'; ?>
<div class="index-message">
  <div class="thread-author-image">
    <img src="//www.gravatar.com/avatar/{{ md5($thread->creator()->email) }} ?s=100" alt="{{ $thread->creator()->name }}" class="img-square">
  </div>
