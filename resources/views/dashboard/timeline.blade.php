                            ...
                            @foreach($timeline_data as $td)
                                ...
                                <li>
                                    ...
                                    <div class="timeline-item">
                                        <span class="time"><i
                                                    class="fas fa-sm fa-clock"></i> {{ \Carbon\Carbon::parse($td['date'])->format('m/d/Y H:i') }}</span>

                                        <h3 class="timeline-header"><strong>{{ ucfirst($td['type']) }}</strong> added
                                        </h3>
                                        @if($td['headline'])
                ...
                <div class="modal-body">
                    ...
                    <form role="form" method="post" action="/dashboard/cases/create">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <select class="custom-select" name="status" id="inputGroupSelect01" aria-label="Status"
                        ...
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" id="case_number" value="{{ $case->number }}"
                                   name="case_number" aria-label="Case Number">
                        </div>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" id="court_name" value="{{ $case->court_name }}"
                                   name="court_name" aria-label="Court name">
                        </div>
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" id="opposing_councel"
                                   value="{{ $case->opposing_councel }}" name="opposing_councel"
                                   aria-label="Opposing Councel">
                        </div>
                        <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="billing_rate"
                                   value="{{ $case->billing_rate }}" aria-label="Amount (to the nearest dollar)">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <label>Hours</label>
                            <input type="text" class="form-control" name="hours" value="{{ $case->hours }}"
